...
<head>
  ...
  <title>book.sql_BookManager_NowcoderGit_牛客网</title>
...
</div>        <div class="commit-info-box">add book.sql
</div>
        <div class="git-bd">
          <section>
            <div class="commit-file-detail">
              <div class="commit-file-hd clearfix">
                ...
                <div class="commit-file-info">
                  ...
                  <a href="/11000160/BookManager/commit/678a414be11c0b236c5d31731ebaf8868eeec3fe">678a414b</a>
...
<div class="blob-content" data-blob-id="829ee922185df7185ea5710d1122d6ede525a559">
...
<span id="LC10" class="line" lang="sql"><span class="o">#</span> <span class="n">Generation</span> <span class="n">Time</span><span class="p">:</span> <span class="mi">2018</span><span class="o">-</span><span class="mi">08</span><span class="o">-</span><span class="mi">21</span> <span class="mi">06</span><span class="p">:</span><span class="mi">08</span><span class="p">:</span><span class="mi">09</span> <span class="o">+</span><span class="mi">0000</span></span>
...
<span id="LC23" class="line" lang="sql"><span class="o">#</span> <span class="n">Dump</span> <span class="k">of</span> <span class="k">table</span> <span class="n">book</span></span>
<span id="LC24" class="line" lang="sql"><span class="o">#</span> <span class="c1">------------------------------------------------------------</span></span>
<span id="LC25" class="line" lang="sql"></span>
<span id="LC26" class="line" lang="sql"><span class="k">DROP</span> <span class="k">TABLE</span> <span class="n">IF</span> <span class="k">EXISTS</span> <span class="nv">`book`</span><span class="p">;</span></span>
<span id="LC27" class="line" lang="sql"></span>
<span id="LC28" class="line" lang="sql"><span class="k">CREATE</span> <span class="k">TABLE</span> <span class="nv">`book`</span> <span class="p">(</span></span>
<span id="LC29" class="line" lang="sql">  <span class="nv">`id`</span> <span class="n">int</span><span class="p">(</span><span class="mi">11</span><span class="p">)</span> <span class="k">NOT</span> <span class="k">NULL</span> <span class="n">AUTO_INCREMENT</span><span class="p">,</span></span>
<span id="LC30" class="line" lang="sql">  <span class="nv">`name`</span> <span class="n">varchar</span><span class="p">(</span><span class="mi">256</span><span class="p">)</span> <span class="k">DEFAULT</span> <span class="k">NULL</span><span class="p">,</span></span>
<span id="LC31" class="line" lang="sql">  <span class="nv">`author`</span> <span class="n">varchar</span><span class="p">(</span><span class="mi">256</span><span class="p">)</span> <span class="k">DEFAULT</span> <span class="k">NULL</span><span class="p">,</span></span>
<span id="LC32" class="line" lang="sql">  <span class="nv">`price`</span> <span class="n">varchar</span><span class="p">(</span><span class="mi">256</span><span class="p">)</span> <span class="k">DEFAULT</span> <span class="k">NULL</span><span class="p">,</span></span>
<span id="LC33" class="line" lang="sql">  <span class="nv">`status`</span> <span class="n">int</span><span class="p">(</span><span class="mi">11</span><span class="p">)</span> <span class="k">DEFAULT</span> <span class="s1">'0'</span><span class="p">,</span></span>
<span id="LC34" class="line" lang="sql">  <span class="k">PRIMARY</span> <span class="k">KEY</span> <span class="p">(</span><span class="nv">`id`</span><span class="p">),</span></span>
<span id="LC35" class="line" lang="sql">  <span class="k">UNIQUE</span> <span class="k">KEY</span> <span class="nv">`name`</span> <span class="p">(</span><span class="nv">`name`</span><span class="p">)</span></span>
...
<span id="LC38" class="line" lang="sql"><span class="k">LOCK</span> <span class="n">TABLES</span> <span class="nv">`book`</span> <span class="k">WRITE</span><span class="p">;</span></span>
<span id="LC39" class="line" lang="sql"><span class="cm">/*!40000 ALTER TABLE `book` DISABLE KEYS */</span><span class="p">;</span></span>
<span id="LC40" class="line" lang="sql"></span>
<span id="LC41" class="line" lang="sql"><span class="k">INSERT</span> <span class="k">INTO</span> <span class="nv">`book`</span> <span class="p">(</span><span class="nv">`id`</span><span class="p">,</span> <span class="nv">`name`</span><span class="p">,</span> <span class="nv">`author`</span><span class="p">,</span> <span class="nv">`price`</span><span class="p">,</span> <span class="nv">`status`</span><span class="p">)</span></span>
<span id="LC42" class="line" lang="sql"><span class="k">VALUES</span></span>
<span id="LC43" class="line" lang="sql">	<span class="p">(</span><span class="mi">1</span><span class="p">,</span><span class="s1">'枪毙任老道'</span><span class="p">,</span><span class="s1">'大英雄王思文'</span><span class="p">,</span><span class="s1">'100￥'</span><span class="p">,</span><span class="mi">0</span><span class="p">),</span></span>
<span id="LC44" class="line" lang="sql">	<span class="p">(</span><span class="mi">2</span><span class="p">,</span><span class="s1">'论一个演员的自我修养'</span><span class="p">,</span><span class="s1">'斯坦尼斯拉夫斯基'</span><span class="p">,</span><span class="s1">'20.40￥'</span><span class="p">,</span><span class="mi">0</span><span class="p">);</span></span>
<span id="LC45" class="line" lang="sql"></span>
<span id="LC46" class="line" lang="sql"><span class="cm">/*!40000 ALTER TABLE `book` ENABLE KEYS */</span><span class="p">;</span></span>
<span id="LC47" class="line" lang="sql"><span class="n">UNLOCK</span> <span class="n">TABLES</span><span class="p">;</span></span>
<span id="LC48" class="line" lang="sql"></span>
<span id="LC49" class="line" lang="sql"></span>
<span id="LC50" class="line" lang="sql"></span>
<span id="LC51" class="line" lang="sql"><span class="cm">/*!40111 SET SQL_NOTES=@OLD_SQL_NOTES */</span><span class="p">;</span></span>
<span id="LC52" class="line" lang="sql"><span class="cm">/*!40101 SET SQL_MODE=@OLD_SQL_MODE */</span><span class="p">;</span></span>
<span id="LC53" class="line" lang="sql"><span class="cm">/*!40014 SET FOREIGN_KEY_CHECKS=@OLD_FOREIGN_KEY_CHECKS */</span><span class="p">;</span></span>
<span id="LC54" class="line" lang="sql"><span class="cm">/*!40101 SET CHARACTER_SET_CLIENT=@OLD_CHARACTER_SET_CLIENT */</span><span class="p">;</span></span>
<span id="LC55" class="line" lang="sql"><span class="cm">/*!40101 SET CHARACTER_SET_RESULTS=@OLD_CHARACTER_SET_RESULTS */</span><span class="p">;</span></span>
<span id="LC56" class="line" lang="sql"><span class="cm">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */</span><span class="p">;</span></span></code></pre>
</div>
</div>
