...
<head>
  ...
  <title>user.sql_BookManager_NowcoderGit_牛客网</title>
...
<div class="blob-content" data-blob-id="69960f27c30b5a269dd519358fc0d0bff2f2e151">
...
<span id="LC10" class="line" lang="sql"><span class="o">#</span> <span class="n">Generation</span> <span class="n">Time</span><span class="p">:</span> <span class="mi">2018</span><span class="o">-</span><span class="mi">08</span><span class="o">-</span><span class="mi">21</span> <span class="mi">07</span><span class="p">:</span><span class="mi">08</span><span class="p">:</span><span class="mi">43</span> <span class="o">+</span><span class="mi">0000</span></span>
...
<span id="LC23" class="line" lang="sql"><span class="o">#</span> <span class="n">Dump</span> <span class="k">of</span> <span class="k">table</span> <span class="k">user</span></span>
<span id="LC24" class="line" lang="sql"><span class="o">#</span> <span class="c1">------------------------------------------------------------</span></span>
<span id="LC25" class="line" lang="sql"></span>
<span id="LC26" class="line" lang="sql"><span class="k">DROP</span> <span class="k">TABLE</span> <span class="n">IF</span> <span class="k">EXISTS</span> <span class="nv">`user`</span><span class="p">;</span></span>
<span id="LC27" class="line" lang="sql"></span>
<span id="LC28" class="line" lang="sql"><span class="k">CREATE</span> <span class="k">TABLE</span> <span class="nv">`user`</span> <span class="p">(</span></span>
...
<span id="LC31" class="line" lang="sql">  <span class="nv">`email`</span> <span class="n">varchar</span><span class="p">(</span><span class="mi">256</span><span class="p">)</span> <span class="k">DEFAULT</span> <span class="s1">''</span><span class="p">,</span></span>
<span id="LC32" class="line" lang="sql">  <span class="nv">`password`</span> <span class="n">varchar</span><span class="p">(</span><span class="mi">256</span><span class="p">)</span> <span class="k">DEFAULT</span> <span class="s1">''</span><span class="p">,</span></span>
...
<span id="LC34" class="line" lang="sql"><span class="p">)</span> <span class="n">ENGINE</span><span class="o">=</span><span class="n">InnoDB</span> <span class="k">DEFAULT</span> <span class="n">CHARSET</span><span class="o">=</span><span class="n">utf8</span><span class="p">;</span></span>
<span id="LC35" class="line" lang="sql"></span>
<span id="LC36" class="line" lang="sql"></span>
<span id="LC37" class="line" lang="sql"></span>
<span id="LC38" class="line" lang="sql"></span>
<span id="LC39" class="line" lang="sql"><span class="cm">/*!40111 SET SQL_NOTES=@OLD_SQL_NOTES */</span><span class="p">;</span></span>
<span id="LC40" class="line" lang="sql"><span class="cm">/*!40101 SET SQL_MODE=@OLD_SQL_MODE */</span><span class="p">;</span></span>
<span id="LC41" class="line" lang="sql"><span class="cm">/*!40014 SET FOREIGN_KEY_CHECKS=@OLD_FOREIGN_KEY_CHECKS */</span><span class="p">;</span></span>
<span id="LC42" class="line" lang="sql"><span class="cm">/*!40101 SET CHARACTER_SET_CLIENT=@OLD_CHARACTER_SET_CLIENT */</span><span class="p">;</span></span>
<span id="LC43" class="line" lang="sql"><span class="cm">/*!40101 SET CHARACTER_SET_RESULTS=@OLD_CHARACTER_SET_RESULTS */</span><span class="p">;</span></span>
<span id="LC44" class="line" lang="sql"><span class="cm">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */</span><span class="p">;</span></span></code></pre>
</div>
</div>
